    ...
    this.agent = new Agent({
      ...
      instructions: ({ requestContext }) => {
        ...
        return [
          ...
          'Use epoch milliseconds for date anchors and always emit the matching IANA timezone field. Never infer a server-local timezone; preserve the provided timezone or use explicit UTC when none was supplied.',
