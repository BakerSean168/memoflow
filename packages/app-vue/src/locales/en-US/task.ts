export default {
  ...
  error: {
    ...
    createTemplateWithTodayInstanceSuccess:
      "Task plan created and today's to-do generated ({count} total)",
    createTemplateWithoutTodayInstanceSuccess:
      'Task plan created with no to-do due today ({count} total)',
    ...
    createQuickTaskWithoutTodayInstanceSuccess:
      'Quick task created, but no to-do was generated for today. Check its start date.',
    ...
    loadFailedDescription:
      'The task plan and occurrence projections are temporarily unavailable. Try again without changing their durable state.',
  },
  management: {
    title: 'Tasks',
    ...
    confirmDelete:
      'Deleting task plan "{name}" also deletes all of its to-dos and execution history. This cannot be undone. Delete it?',
  ...
  detail: {
    ...
    edit: 'Edit',
    subtitle:
      'Manage one long-lived plan, its properties, checklist, and task occurrences in one workspace.',
    planSettings: 'Plan settings',
    planSettingsDescription:
      'Scheduling, recurrence, reminders, and Goal contribution belong to the plan—not to one occurrence.',
  ...
  templateDialog: {
    ...
    updateImpact:
      'This will update {count} unstarted to-dos. In-progress and past to-dos are unchanged.',
    cancel: 'Cancel',
  ...
  krLinks: {
    ...
    contributionHint:
      'When enabled, completion updates this key result. Leave it off for a link-only relationship.',
  ...
  templateForm: {
    ...
    notFoundMessage:
      'The task plan being edited was not found. Please select or create a task plan.',
    close: 'Close',
  ...
  templateMgmt: {
    ...
    emptyDescription:
      'The task library holds repeatable task definitions: recurrence rules, reminders, and goal bindings.',
