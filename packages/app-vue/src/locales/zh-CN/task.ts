export default {
  ...
  error: {
    ...
    loadFailedDescription: '任务计划与执行项暂时不可用。请重试；重试不会改写它们的持久状态。',
  },
  management: {
    title: '任务',
    ...
    confirmDelete:
      '删除任务计划「{name}」会同时删除其全部待办任务和执行历史，且无法撤销。确认删除？',
    confirmDeleteAll: '确认删除全部任务计划？此操作不可撤销！',
    pauseTitle: '暂停任务计划？',
    pauseDescription:
      '暂停「{name}」后，将停止生成新的待办任务，并删除当前时刻之后待完成或进行中的待办任务；已到期和已完成历史保持不变。',
    allDeleted: '所有任务计划已删除',
    subtitle: '优先处理今天的执行项，再查看后续安排；长期计划配置保持独立。',
    surface: {
      today: '今天',
      upcoming: '后续',
      plans: '计划',
    ...
    emptyUpcoming: '暂无后续执行项',
    emptyOccurrenceDescription: '创建或调整计划后，系统会生成符合条件的执行项。',
  },
  detail: {
    title: '任务计划工作区',
    loading: '加载中...',
    ...
    edit: '编辑',
    subtitle: '在一个工作区中管理长期计划、属性、检查清单与任务执行项。',
    planSettings: '计划设置',
