...
import type { TaskPlanSummary } from '../hooks/useTaskPlans';
...
function statusTone(status: TaskPlanSummary['status']) {
  if (status === 'Active') return 'success' as const;
  if (status === 'Paused') return 'warning' as const;
  return 'textSecondary' as const;
}

function importanceTone(importance: TaskPlanSummary['importance']) {
