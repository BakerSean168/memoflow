...
| Home / AI composition | The standalone cross-domain read surface is retired; Home/Goal and AI analytics use owner reads, and API recent activity is owner-derived like Desktop | `owner-activity-read.adapter.spec.ts`, `TodayOverviewPanel.spec.ts`, Home/AI journey suites |
