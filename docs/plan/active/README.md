...
| 计划                                                                                                      | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Task vNext Model Convergence](./2026-09-08-task-vnext-model-convergence.md)                              | **ACTIVE / TASK-7305 complete; TASK-7306 next** — TaskPlan persistence 已 destructive-cut 为 Prisma `schedule Json` + full reminder JSON、PowerSync canonical JSON text；18 个旧 time/recurrence/reminder/cursor 物理列已删除，portable backup 同步只接受 canonical `schedule + reminderConfig`。Task 74/590、PostgreSQL 6/31（另有 fresh DB 6/31）、Contracts 85/581、Data Portability 36/148、Database 11/37、PowerSync schema 1/7 全绿。下一步统一切换 application / HTTP / IPC / Planner / AI consumers 并删除 compatibility DTO/query surface。 |
