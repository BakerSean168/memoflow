...
updated: 2026-09-13T10:52:00+08:00
---
...
| 计划                                                                                                      | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Task vNext Model Convergence](./2026-09-08-task-vnext-model-convergence.md)                              | **ACTIVE / TASK-7302 complete; TASK-7303 next** — TaskPlan 已彻底移除 occurrence collection/hydration，materialization 转由 service + explicit existing occurrences，Plan query 改为 read-side composition；Task 73 files / 671 tests、PostgreSQL 6 files / 31 tests、typecheck/build/lint gate 通过。下一步收敛 TaskOccurrence schedule snapshot / Result / checklist，并按 ADR-111 协调最小 persistence direct-cutover。 |
