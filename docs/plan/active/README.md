...
| 计划                                                                                                      | 当前状态                                                                                                                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Goal vNext Model Convergence](./2026-09-08-goal-vnext-model-convergence.md)                              | **ACTIVE / implementation advanced** — `GOAL-7202～7208` 已完成：Goal/KR canonical model、Task/Knowledge Context、Goal Workspace 与 AI GoalPlanDraft V2 均已落地；下一项为 `GOAL-7209` Linear-style UI convergence，之后执行 legacy cleanup 与最终 review。                               |
