...
| 计划                                                                                                      | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Task vNext Model Convergence](./2026-09-08-task-vnext-model-convergence.md)                              | **ACTIVE / TASK-7307 complete; TASK-7308 next** — TaskPlan/TaskOccurrence application、HTTP/IPC、Planner/Scheduling 与 AI consumers 已完成 canonical cutover；Occurrence transport 只暴露 `planId + scheduleSnapshot + result/checklist + derived dueAt`，reschedule 只接受 `occurrenceId + scheduleSnapshot`，legacy QueryValidator 已删除。Task 74/590、Contracts 85/581、app-vue 207/806、HTTP occurrence smoke 32/32、plan smoke 29/29、HTTP/IPC parity 17/17 全绿。Task UI convergence / TaskPlanWorkspace-facing interaction 已完成；下一步做 TASK-7308 context read model（labels + Goal/KR + occurrence summary + recent occurrences + linked notes）。 |
