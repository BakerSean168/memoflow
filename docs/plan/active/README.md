...
| 计划                                                                                                      | 当前状态                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| --------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Task vNext Model Convergence](./2026-09-08-task-vnext-model-convergence.md)                              | **ACTIVE / TASK-7308 complete; TASK-7309 next** — TaskPlan/TaskOccurrence application、HTTP/IPC、Planner/Scheduling 与 AI consumers 已完成 canonical cutover；Occurrence transport 只暴露 `planId + scheduleSnapshot + result/checklist + derived dueAt`，reschedule 只接受 `occurrenceId + scheduleSnapshot`，legacy QueryValidator 已删除。Task 74/590、Contracts 85/581、app-vue 207/806、HTTP occurrence smoke 32/32、plan smoke 29/29、HTTP/IPC parity 17/17 全绿。TaskPlanWorkspace context read model 已完成并通过独立验收：owner-side occurrence summary/recent、Goal/KR fail-soft、ADR-090 stable linked notes、HTTP/IPC workspace transport 均已落地；下一步做 TASK-7309 legacy deletion。 |
