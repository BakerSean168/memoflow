...
/**
 * API-host binding for GoalPlanDraft V2.
 *
 * The adapter only composes already-owned application capabilities. AI never
 * imports Goal/Task/Repository/Relation repositories and never opens a shared
