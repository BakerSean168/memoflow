...
## [0.15.0](https://github.com/BakerSean168/memoflow/compare/v0.14.1...v0.15.0) (2026-09-26)


### Features

* **ai:** add bounded context assembler seam ([6de5029](https://github.com/BakerSean168/memoflow/commit/6de50297508243f67d4d78e3fa5612bfa6d424dd))
* **ai:** add capability-aware model resolution ([2df140a](https://github.com/BakerSean168/memoflow/commit/2df140a650aae8919ddba3f5f6ee2fc709c3977f))
* **ai:** add capability-aware model resolution ([cefeb2f](https://github.com/BakerSean168/memoflow/commit/cefeb2f9a3599b3becac698e6f9d49e424113044))
* **ai:** add conversation shell portable v3 capability ([2685213](https://github.com/BakerSean168/memoflow/commit/2685213e5210964a72970275d626da688e9d247a))
* **ai:** add conversation shell portable v3 capability ([7017e8a](https://github.com/BakerSean168/memoflow/commit/7017e8a00f84ac8747d7a30947b91c19a691a132))
* **ai:** close Phase 5 runtime and Home analytics foundation ([31492d0](https://github.com/BakerSean168/memoflow/commit/31492d030576259862f9e8e3c0672c0b267e0b9e))
* **ai:** converge conversation shell runtime authority ([a897f0a](https://github.com/BakerSean168/memoflow/commit/a897f0acbf89d20337d361c9241cf5a098ec9c19))
* **ai:** separate provider connections from host-owned secrets ([b692305](https://github.com/BakerSean168/memoflow/commit/b692305c9c9a2636e36144c05b83952c9fff6679))
* **ai:** separate provider credentials from connections ([e6c8ca4](https://github.com/BakerSean168/memoflow/commit/e6c8ca435774385d50dcd7481643682faa37d323))
* close phase 4 owner foundations ([58278f2](https://github.com/BakerSean168/memoflow/commit/58278f2b093cf20c2da0f0d2b8254b138f08cb88))
* close Phase 4 owner foundations ([6bd18ff](https://github.com/BakerSean168/memoflow/commit/6bd18ff38f15e27025d0f9bc47f912085a56ee11))
* **data-portability:** add owner-driven v3 foundation ([106408f](https://github.com/BakerSean168/memoflow/commit/106408fb8cb3a59e760c66ff0fb4cd88997f57d6))
* **data-portability:** add v3 capability coordinator ([28808ed](https://github.com/BakerSean168/memoflow/commit/28808ed50e2ac9b79258aafd86eb838ad0fb680a))
* **desktop:** persist profile notification preferences ([195d849](https://github.com/BakerSean168/memoflow/commit/195d84996a82aefc82d9c76aa141090ff7b18fe2))
* **goal:** add workspace read composition ([cded38d](https://github.com/BakerSean168/memoflow/commit/cded38d54fb721bd14b2e55075ea1e2c846e3cd4))
* **goal:** apply AI goal plans with stable draft refs ([e75938f](https://github.com/BakerSean168/memoflow/commit/e75938f53379b3d9d8bdd2436c90937de04a7227))
* **goal:** converge vnext goal workspace UI ([e9b467c](https://github.com/BakerSean168/memoflow/commit/e9b467c4318a0a4e69dd3e3f4db35ee6fded768d))
* **goal:** refine editable goal form surfaces ([5fa17c6](https://github.com/BakerSean168/memoflow/commit/5fa17c65a1d35e7c1c9ac02bf7355d4a1cfe231c))
* **goal:** refine editable goal form surfaces ([cc557b9](https://github.com/BakerSean168/memoflow/commit/cc557b95d3cb7cfbc591fe67cd9fedd8a2ab490e))
* **governance:** bridge pinned rule bundles to engineering checks ([ba30436](https://github.com/BakerSean168/memoflow/commit/ba3043642376981cb2a3ac0b64fe3fdf26566892))
* **governance:** gate development workbench ([cac55d5](https://github.com/BakerSean168/memoflow/commit/cac55d5fa01673fbfb1dad344a90ed93f15bf517))
* **governance:** publish deterministic rule bundles ([0c6f10d](https://github.com/BakerSean168/memoflow/commit/0c6f10d7234a76123244658f5a15cc74361eea52))
* **home:** cut AI analytics from Dashboard ([9bff680](https://github.com/BakerSean168/memoflow/commit/9bff6806ebfa341573aa294424b8154871c56bb8))
* **home:** cut Home progress reads to Goal owner ([dfdc70a](https://github.com/BakerSean168/memoflow/commit/dfdc70a10dccd9a59615073a27b00fece77203b2))
* **home:** read Goal progress from canonical owner ([5e78e94](https://github.com/BakerSean168/memoflow/commit/5e78e94982982eb4b762ddcc54321f53fa1fb34f))
* **notification:** finish typed interaction boundaries ([1cae0b4](https://github.com/BakerSean168/memoflow/commit/1cae0b4451111fab036bc19155606a035cb70728))
* **notification:** finish typed interaction boundaries ([18bbdf7](https://github.com/BakerSean168/memoflow/commit/18bbdf76708e53653f0aae4dc87cc840d4a94838))
* persist AI routine creation canonically ([275251f](https://github.com/BakerSean168/memoflow/commit/275251fc957f780b9c3406cd61ede34d399bcdde))
* **planner:** derive occupancy and conflicts ([48e3aeb](https://github.com/BakerSean168/memoflow/commit/48e3aeb7520db376101b2def9dcb66b9472c80e0))
* **planner:** derive occupancy and conflicts ([cc90acf](https://github.com/BakerSean168/memoflow/commit/cc90acf5dea6e7fd6c0509449a77b0da10500c37))
* **portability:** add account profile v3 capability ([e50a111](https://github.com/BakerSean168/memoflow/commit/e50a111a618d65157a7b012533f5da5891963815))
* **portability:** add account profile v3 capability ([04ee1c0](https://github.com/BakerSean168/memoflow/commit/04ee1c0123cc250801304c4c54f304d1d1f20dfd))
* **portability:** add label and goal v3 capabilities ([8bf3fa4](https://github.com/BakerSean168/memoflow/commit/8bf3fa4c0c90dbdba6559cf9ed5bf136e00a1eda))
* **portability:** add label and goal V3 owner capabilities ([fa3804d](https://github.com/BakerSean168/memoflow/commit/fa3804d6cbc3ff05e5351e4c40e3b164545a5f76))
* **portability:** add Phase 4 owner V3 capabilities ([b428856](https://github.com/BakerSean168/memoflow/commit/b428856d737f2d2b9f212a6a29bd990e11ebd39e))
* **portability:** add Phase 4 owner V3 capabilities ([387ff83](https://github.com/BakerSean168/memoflow/commit/387ff8374e2873cd0cf6fa620ccb8ff22ae72aa4))
* **portability:** add task v3 capability ([62af14d](https://github.com/BakerSean168/memoflow/commit/62af14df38f2b2a469c0898e469b9616d8aab404))
* **portability:** add task v3 capability ([ffe7ea7](https://github.com/BakerSean168/memoflow/commit/ffe7ea7119e86f4082221dd73303fc51095c4e87))
* **portability:** close task v3 production wiring ([02470f7](https://github.com/BakerSean168/memoflow/commit/02470f7a1259a0777266e0187e1ae321b175a16b))
* **portability:** register notification delivery preferences ([e59f1e2](https://github.com/BakerSean168/memoflow/commit/e59f1e22ed37b6f0c0ef499468ec13f3930c9e88))
* **relation:** promote shared goal knowledge relations ([a5e1777](https://github.com/BakerSean168/memoflow/commit/a5e177707a441496d1feff4671e38effdb30f54b))
* **routine:** converge occurrence and interaction truth ([daeb63c](https://github.com/BakerSean168/memoflow/commit/daeb63c7cf7e2cfd6d9416720e85fb9bcf9ba891))
* **routine:** converge occurrence and interaction truth ([d260f77](https://github.com/BakerSean168/memoflow/commit/d260f777e7cd8fc93ad631084d8251fe74e35e22))
* **routine:** persist AI routine creation canonically ([008adbe](https://github.com/BakerSean168/memoflow/commit/008adbea5a573f68c850a1235c19c7938f8aae49))
* **routine:** wire canonical reminder scheduling ([e0f1acc](https://github.com/BakerSean168/memoflow/commit/e0f1acc061a7f72ced68c9a2d63c23932d3d14f4))
* **runtime:** standardize environment ownership ([178573e](https://github.com/BakerSean168/memoflow/commit/178573e8cb5162444836d2377b55a1c95295be75))
* **runtime:** standardize MemoFlow environment ownership ([f7ab120](https://github.com/BakerSean168/memoflow/commit/f7ab120e760b7c26d9f9e29730849b0bca64c725))
* **schedule:** cut CalendarEntry to range truth ([9c3f275](https://github.com/BakerSean168/memoflow/commit/9c3f2753fd88949bddd5277aeb79a645804e98b4))
* **schedule:** cut CalendarEntry to range truth ([3e04755](https://github.com/BakerSean168/memoflow/commit/3e04755267e3cc1da41b83eb803888b1f911ce52))
* **setting:** add canonical preference foundation ([4e85573](https://github.com/BakerSean168/memoflow/commit/4e85573af701d2d1467e9b2a8ae2f9ed1b224504))
* **setting:** compose settings hub by owner ([a835ba1](https://github.com/BakerSean168/memoflow/commit/a835ba166c6c74c96e82659a49d78f6caa57f12b))
* **setting:** cut preference portability to v3 ([c3ad6bb](https://github.com/BakerSean168/memoflow/commit/c3ad6bb834084e886941db3e60e003a6ef27a445))
* **task:** add TaskPlanWorkspace context read model ([9b5229c](https://github.com/BakerSean168/memoflow/commit/9b5229c09b9666a9306b8dd3477749dd28a45f6b))
* **task:** converge task occurrence vnext ([ae5fbe6](https://github.com/BakerSean168/memoflow/commit/ae5fbe68a56e2ee5ac5c715ec8675532870e1985))
* **task:** cut over task plan persistence vnext ([a4173bf](https://github.com/BakerSean168/memoflow/commit/a4173bf0f4a2d4993c2b96413186483c5e6c527f))
* **task:** finalize TASK-7307 plan workspace convergence ([da192c3](https://github.com/BakerSean168/memoflow/commit/da192c33d2960e7920f99bb02ba97d758c56eae2))
* **task:** remove occurrence generation cursor ([f7f2b2d](https://github.com/BakerSean168/memoflow/commit/f7f2b2d8491c0cb325a1da7bc08addd749918e03))
* **ui:** complete product surface refinement v2 ([114043b](https://github.com/BakerSean168/memoflow/commit/114043bb001923348c16425582bc374d79673029))
* **ui:** polish product detail surfaces ([0b34357](https://github.com/BakerSean168/memoflow/commit/0b34357ce5d78cc66b3dabcf0249fb1ccfbd7997))
* **ui:** refine product forms and dialog surfaces ([146f86a](https://github.com/BakerSean168/memoflow/commit/146f86a37f32f93124c67a96cb3bf414db47ccba))
* **ui:** refine product forms and dialog surfaces ([600406e](https://github.com/BakerSean168/memoflow/commit/600406e52efce988748e79e48394171ce6c2892d))


### Bug Fixes

* **account:** enforce portable profile invariants ([7a874ad](https://github.com/BakerSean168/memoflow/commit/7a874adc8bfa3d3fd3e5c2cacba816b19181802f))
* **ai:** keep desktop provider connections host-local ([d8fbdf8](https://github.com/BakerSean168/memoflow/commit/d8fbdf85c45f11bc15278e7c74329c4851474881))
* **ai:** wire production capability evidence ([e2e5572](https://github.com/BakerSean168/memoflow/commit/e2e5572f9747d073532d6ac844b66feb8ec275bb))
* **api:** restore account composer wiring ([c8f6819](https://github.com/BakerSean168/memoflow/commit/c8f681934ca1207e01cf9e6fc761e50d20b6a8d0))
* bind Goal refs during portability preflight ([ae501c5](https://github.com/BakerSean168/memoflow/commit/ae501c52932ae5511878c9d327f3d5d620b0f474))
* **ci:** close setting convergence lint blockers ([41f99bb](https://github.com/BakerSean168/memoflow/commit/41f99bb4d34feb2bf4a6a04a0b55fe05dab0be64))
* **ci:** refresh test inventory counts ([390ce31](https://github.com/BakerSean168/memoflow/commit/390ce3160ce7c122cd31bdb470f847fb3c44b47a))
* close phase 4 validation gaps ([03399ab](https://github.com/BakerSean168/memoflow/commit/03399ab570e05803e3f1b1f1a660cb7ec738bcbf))
* close Task Portability [#343](https://github.com/BakerSean168/memoflow/issues/343) CI blockers ([82baa14](https://github.com/BakerSean168/memoflow/commit/82baa1457a7595dbb544a1abac23137e4419896d))
* close Task portability dry-run review finding ([aeca6f2](https://github.com/BakerSean168/memoflow/commit/aeca6f2b7e2c5631c431e0ad1661edebbb728b93))
* close Task portability reviewer findings ([af81708](https://github.com/BakerSean168/memoflow/commit/af817084b86ae894167e07d988f5981552a607e4))
* converge dashboard on product time contracts ([45eaf35](https://github.com/BakerSean168/memoflow/commit/45eaf352d2e72071f5c58e25023cbdbcda970374))
* **database:** report task goal constraint version ([b85cdff](https://github.com/BakerSean168/memoflow/commit/b85cdffe605bde1ba01b6fcc438621eb7ca6aeed))
* **dev:** restore host development runtime ([9cdfa74](https://github.com/BakerSean168/memoflow/commit/9cdfa74e88ad328564b662b0cfdb432de7154403))
* **docker:** stamp local powersync provenance ([9552dd9](https://github.com/BakerSean168/memoflow/commit/9552dd974199234d45622f8e8d128ac9585d14ae))
* **governance:** refresh dashboard retirement registry counts ([63f5b69](https://github.com/BakerSean168/memoflow/commit/63f5b6976183405940c2b73479457224f1063dd1))
* **governance:** validate multiline label service wiring ([d2ec826](https://github.com/BakerSean168/memoflow/commit/d2ec826ad8fd1a79885d86a862f9e3f2315c1949))
* **home:** satisfy contracts test boundary ([b6f60a6](https://github.com/BakerSean168/memoflow/commit/b6f60a6b9699a693ad2d83b6e3b3babed9327786))
* **home:** stabilize goal preview ordering ([43ee650](https://github.com/BakerSean168/memoflow/commit/43ee650308d94cc4c7ec1bae4b8ea27836dca271))
* **label:** trim after NFKC normalization ([e4a541a](https://github.com/BakerSean168/memoflow/commit/e4a541a7bf52a10a732a8a5a5aacc1f028e1aff2))
* **notification:** fail closed outside Electron runtime ([550a780](https://github.com/BakerSean168/memoflow/commit/550a7800abd58195167566f2221a8ff187c16454))
* **notification:** satisfy static analysis after channel retirement ([b5bfde0](https://github.com/BakerSean168/memoflow/commit/b5bfde0401bb0bc96b07dc9163861a5eb2146373))
* **portability:** align task dry-run with apply ([3453375](https://github.com/BakerSean168/memoflow/commit/3453375430cf89f472f48a03309da543fe7e339a))
* **portability:** bind predicted goal refs in preflight ([0443883](https://github.com/BakerSean168/memoflow/commit/04438833a3914505c20b022d34f0587b46c9143c))
* **portability:** close label and goal V3 gaps ([68eb0fa](https://github.com/BakerSean168/memoflow/commit/68eb0fab1da4672b9fdfc41f044a284d87e99d62))
* **portability:** close task dry-run replay edge ([d00d00c](https://github.com/BakerSean168/memoflow/commit/d00d00c2fe989cef8855cb20931a811f54fbb5be))
* **portability:** isolate deterministic goal ids by identity ([212632e](https://github.com/BakerSean168/memoflow/commit/212632e74f66a7594ce143bf0bdff2abef9381b6))
* **portability:** preflight capability apply graph ([535aa88](https://github.com/BakerSean168/memoflow/commit/535aa883c00f30d6ee4ccc0e26b40c212678a934))
* **portability:** preflight imports before mutation ([af28bd8](https://github.com/BakerSean168/memoflow/commit/af28bd83f13ee2dd38519a775c2c152bc5a0e6e7))
* **portability:** preserve server goal tracking state ([4f32c05](https://github.com/BakerSean168/memoflow/commit/4f32c05f993b3dc3011299e85df0f2370c1dc724))
* **portability:** reject divergent goal replays ([89bb1da](https://github.com/BakerSean168/memoflow/commit/89bb1dabbea659441c961a9fb0b606c3af176706))
* **portability:** repair task v3 CI closure ([fb95862](https://github.com/BakerSean168/memoflow/commit/fb95862e214ca035965cb51ab0ca46269249a859))
* **portability:** validate account birthday in imported timezone ([677173f](https://github.com/BakerSean168/memoflow/commit/677173f911f5e03d64c7e71c4e10b3fe399a65a5))
* preflight portability dependencies before apply ([e3a167c](https://github.com/BakerSean168/memoflow/commit/e3a167ce30ecf1fe6f3d9bfda20ceb76a4f7fbf4))
* protect Notification Fact navigation intent ([0c352ca](https://github.com/BakerSean168/memoflow/commit/0c352ca7e633810611840927cbaf8ca884bbde00))
* **reminder:** avoid database singleton on root import ([bb34287](https://github.com/BakerSean168/memoflow/commit/bb3428789f123d86a7fa696f56d9359054547ec4))
* **reminder:** avoid database singleton on root import ([93a672b](https://github.com/BakerSean168/memoflow/commit/93a672b5106c6cfd04692286b2a377b242ae9dfc))
* **routine:** harden interaction idempotency fence ([893791f](https://github.com/BakerSean168/memoflow/commit/893791ffe2f0366409532ebc87f0b32dbb7315aa))
* **routine:** harden interaction idempotency fence ([f5f5d55](https://github.com/BakerSean168/memoflow/commit/f5f5d557aa29bdf0bba9a6402836f3081caa28ed))
* **routine:** keep desktop composer on public seam ([d84d708](https://github.com/BakerSean168/memoflow/commit/d84d708ea9770fa31c3b200be55cb675b5a93511))
* **routine:** preserve compound PowerSync ownership ([dfb1812](https://github.com/BakerSean168/memoflow/commit/dfb1812d12f20f8e8425508132b69e477c92e962))
* **routine:** repair user time and desktop profile refresh ([e9d4d05](https://github.com/BakerSean168/memoflow/commit/e9d4d05bda0caa65fe47e41459a3364a30bb4796))
* **routine:** restore adjacent owner projections ([852ab9e](https://github.com/BakerSean168/memoflow/commit/852ab9e324d490fae36241dc24bb9bfa8b227a2f))
* **routine:** restore adjacent owner surfaces and WallClock convergence ([bc9c460](https://github.com/BakerSean168/memoflow/commit/bc9c46066867ca002f75bc84757d1741e838ebdf))
* **routine:** restore canonical configuration surface ([a031749](https://github.com/BakerSean168/memoflow/commit/a0317498d17ef8c0f0367198d27108d7575983f7))
* **routine:** restore canonical configuration surface ([5bd206b](https://github.com/BakerSean168/memoflow/commit/5bd206b767da2541bcd0facfcb7aa01283ae505b))
* **routine:** restore wallclock eligibility convergence ([c586ee2](https://github.com/BakerSean168/memoflow/commit/c586ee213178c416768bacd3913a60e485374101))
* **runtime:** align host-dev with global port block ([c97ce1e](https://github.com/BakerSean168/memoflow/commit/c97ce1eec679e8797ea4138a8a1e820ed1b708f2))
* **runtime:** align host-dev with global port block ([b82bdcf](https://github.com/BakerSean168/memoflow/commit/b82bdcffda79bb16cce38dbf873654614bd70811))
* **schedule:** roll default range across midnight ([60accd3](https://github.com/BakerSean168/memoflow/commit/60accd3801d4e065983bca0fea7224d87a6aac21))
* **setting:** close local vnext review findings ([f94de6d](https://github.com/BakerSean168/memoflow/commit/f94de6de6645232380c469fbc72813af46e401ff))
* **task:** align downstream vnext consumers ([551e632](https://github.com/BakerSean168/memoflow/commit/551e632d300194f2332f5843dd3dd62a11b52a36))
* **task:** close exact-head e2e and performance gates ([dd9f391](https://github.com/BakerSean168/memoflow/commit/dd9f391b6b45d91f2c94dc1ad7bb61b9c890ccbd))
* **task:** enforce checklist identity and version invariants ([50f86db](https://github.com/BakerSean168/memoflow/commit/50f86db6d057742c1fde4f375fc6252775875824))
* **task:** normalize one-time generation window ([fb30923](https://github.com/BakerSean168/memoflow/commit/fb309231faf1471d89dff83f556afb272cfedc52))
* **task:** preserve goal-link toggle before selection ([2f88ffa](https://github.com/BakerSean168/memoflow/commit/2f88ffacb2e1ce51004713c16285e89226555b44))
* **task:** repair exact-head convergence gates ([c547816](https://github.com/BakerSean168/memoflow/commit/c547816be09cc8146291999cdffac78a3919088d))
* **web:** align planner flow with CI product time ([1de6b7c](https://github.com/BakerSean168/memoflow/commit/1de6b7c3159a57e0550c939046ac9b331ea0b4bc))
* **web:** close task projection and portability regressions ([95f194d](https://github.com/BakerSean168/memoflow/commit/95f194d8264b1ae34971a3dbf06b5ca2b36dfd8e))
* **web:** harden planner vnext runtime closure ([1a52851](https://github.com/BakerSean168/memoflow/commit/1a52851a5581ff3680e83d041a5696781f9903f9))


### Performance Improvements

* **deploy:** fast-path unchanged production watcher ([9d99764](https://github.com/BakerSean168/memoflow/commit/9d997643a9b0a13a50302026ae3f42d9c8fb4471))
* **dev:** enable bundled remote Vite workflow ([a86cb71](https://github.com/BakerSean168/memoflow/commit/a86cb71658174d53cad1240fe5fb045c047f2295))
* **dev:** enable bundled remote Vite workflow ([bb86a80](https://github.com/BakerSean168/memoflow/commit/bb86a80deb301afd7f1769989f8970cc600a2630))
